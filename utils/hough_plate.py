...
def rearrange_points(corners):
    ...
    # bottom_left_x = corners_copy[0][0][0]
    # bottom_left_y = corners_copy[0][0][1]

    # bottom_right_x = corners_copy[1][0][0]
    # bottom_right_y = corners_copy[1][0][1]

    # top_right_x = corners_copy[2][0][0]
    # top_right_y = corners_copy[2][0][1]

    # top_left_x = corners_copy[3][0][0]
    # top_left_y = corners_copy[3][0][1]

    # corners_copy = np.array([[[bottom_left_x, bottom_left_y]], [[bottom_right_x, bottom_right_y]], [[top_right_x, top_right_y]], [[top_left_x, top_left_y]]], dtype = np.int32)
    return corners_copy
